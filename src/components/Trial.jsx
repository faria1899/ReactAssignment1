...
function Trial({ title = "Start your free trial today", description = "Try Landwind Platform for 30 days. No credit card required.", buttonText = "Free trial for 30 days", buttonLink = "#" }) {
  return (
    <div>
